...
export default async function Home(props: {
  ...
  const attenderName = typeof searchParams.attenderName === "string" ? searchParams.attenderName.trim() : "";
  const attenderId = typeof searchParams.attenderId === "string" ? searchParams.attenderId.trim() : "";
  const shopLocation = typeof searchParams.shopLocation === "string" ? searchParams.shopLocation.trim() : "";

  const isFromQR = !!(attenderName && attenderId && shopLocation);
